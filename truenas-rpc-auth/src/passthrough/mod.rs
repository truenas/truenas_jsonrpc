...
//! [`SetupOutcome::Takeover`](truenas_rpc::SetupOutcome), and the server gates the connection and
...
//!
//! [`run_transfer`]: https://docs.rs/truenas-rpc-server
...
use truenas_rpc::{FileTransfer, JsonRpcError, Session, SessionId, SessionLifecycle, SetupHandoff};
