...
impl<T: Transport> SampleClient<T> {
    ...
    pub async fn query(&self, request: QueryArgs, query_filters: Option<truenas_rpc::QueryFilters>, query_options: Option<truenas_rpc::QueryOptions>) -> Result<QueryResult<Entry>, truenas_rpc::JsonRpcError> {
